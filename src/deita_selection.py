...
if __name__ == '__main__':
    ...
    parser.add_argument('--full_dataset_file', default='./sample_data/deita_alpaca.jsonl', type=str)
    ...
    embed_pipeline = Pipeline("embed_pipeline", 
                            data_path = os.path.join(args.full_dataset_file),   # json file with sharegpt format
